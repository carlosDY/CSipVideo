...
import com.csipsimple.VideoPuerta.VideoPuerta_Fragment;
import com.csipsimple.api.SipConfigManager;
import com.csipsimple.api.SipManager;
import com.csipsimple.api.SipProfile;
import com.csipsimple.garage.garage_Fragment;
...
public class SipHome extends SherlockFragmentActivity implements OnWarningChanged {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(favoritesTab != null) {
            mTabsAdapter.addTab(favoritesTab, garage_Fragment.class, TAB_ID_FAVORITES);
        }
        if (messagingTab != null) {
            mTabsAdapter.addTab(messagingTab, VideoPuerta_Fragment.class, TAB_ID_MESSAGES);
        }
