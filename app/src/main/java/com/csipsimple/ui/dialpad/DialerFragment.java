...
public class DialerFragment extends SherlockFragment implements OnClickListener, OnLongClickListener,
    ...
    */
    ...
    private void initButtons(View v) {
      ...
      //  Botons = (Button) v.findViewById(R.id.BottonPrueba);
       // Botons.setOnClickListener(this);

        //Botons1= (Button) v.findViewById(R.id.Prueba);
        //Botons1.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        else if(viewId==Botons.getId()){
            Intent Intent = new Intent("applicationB.intent.action.Launch");
            startActivity(Intent);
        }

        else if(viewId==Botons1.getId()){
            Intent Intent = new Intent("applicationA.intent.action.Launch");
            startActivity(Intent);
        }
